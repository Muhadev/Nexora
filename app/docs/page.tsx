    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          NeXora is a comprehensive platform combining multiple UI libraries,
      ...
      <section className="mb-12">
        ...
        <p className="text-gray-600 dark:text-gray-400 leading-relaxed">
          Components in NeXora can be installed in two ways:
        </p>
      ...
      <section>
        ...
        <Accordion type="single" collapsible className="space-y-4">
          <AccordionItem value="q1">
            ...
            <AccordionContent>
              NeXora is a collection of reusable components and styles from
          ...
          <AccordionItem value="q3">
            <AccordionTrigger>How do I install NeXora?</AccordionTrigger>
            <AccordionContent>
              Each component in NeXora has its own installation guide, which
          ...
          <AccordionItem value="q4">
            ...
            <AccordionContent>
              Yes, all components in NeXora are highly customizable. Modify
